...
import cs383.wc.edu.walker.game_models.InfiniteBirdsWorld;
...
//only warning is for TextureView Listener, don't know how to get rid of it and it works without it
@SuppressWarnings("All")
public class ForeverActivity extends GameActivity implements SensorEventListener {
    ...
    private MediaPlayer bulletImpact, bulletLaunch, SHREKED;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        world = new InfiniteBirdsWorld(this);
...
//        soundPool.play(R.raw.danger_zone, 1f, 1f, 1, -1, 1f);
        ...
        SHREKED = MediaPlayer.create(this, R.raw.shrek);
        SHREKED.setLooping(true);
        SHREKED.start();
